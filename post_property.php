   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <div class="flex">
         <div class="box">
            ...
            <input type="number" name="price" required min="0" max="9999999999" maxlength="10" placeholder="Enter price" class="input">
         </div>
         <div class="box">
         ...
         <div class="box">
            ...
            <input type="number" name="carpet" required min="1" max="9999999999" maxlength="10" placeholder="How many Sq ft?" class="input">
         </div>
         <div class="box">
      ...
      <div class="box">
         <p>Detailed Property Description <span>*</span></p>
      ...
      <div class="checkbox">
         <div class="box">
            ...
            <p><input type="checkbox" name="water_supply" value="yes" />Free Water supply</p>
            <p><input type="checkbox" name="power_backup" value="yes" />24/7 Power backup</p>
         </div>
         <div class="box">
            <p><input type="checkbox" name="parking_area" value="yes" />Parking</p>
            <p><input type="checkbox" name="gym" value="yes" />Gym</p>
            <p><input type="checkbox" name="shopping_mall" value="yes" />Nearby shopping mall(s)</p>
            <p><input type="checkbox" name="hospital" value="yes" />Nearby hospital(s)</p>
            <p><input type="checkbox" name="school" value="yes" />Nearby school(s)</p>
            <p><input type="checkbox" name="market_area" value="yes" />Nearby local market</p>
         </div>
      </div>
      <div class="box">
