...
<header class="header">
   ...
   <nav class="navbar nav-1">
      <section class="flex">
         <a href="home.php" class="logo"><i class="fas fa-house"></i>Real Estate Development</a>

         <ul>
            <li><a href="post_property.php">Add Property<i class="fas fa-paper-plane"></i></a></li>
         </ul>
      </section>
   </nav>
            ...
            <ul>
               <li><a href="#">My listings<i class="fas fa-angle-down"></i></a>
                  <ul>
                     ...
                     <li><a href="post_property.php">Add Property</a></li>
