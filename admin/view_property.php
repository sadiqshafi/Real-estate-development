   ...
   <div class="details">
     <div class="swiper images-container">
      ...
      <div class="info">
         ...
         <p><i class="fas fa-phone"></i><a href="tel:01234567890"><?= $fetch_user['number']; ?></a></p>
      ...
      <div class="flex">
         ...
         <div class="box">
            <p><i>Sq ft area :</i><span><?= $fetch_property['carpet']; ?> sqft</span></p>
      ...
      <div class="flex">
         ...
         <div class="box">
            ...
            <p><i class="fas fa-<?php if($fetch_property['shopping_mall'] == 'yes'){echo 'check';}else{echo 'times';} ?>"></i><span>Nearby shopping mall(s)</span></p>
            <p><i class="fas fa-<?php if($fetch_property['hospital'] == 'yes'){echo 'check';}else{echo 'times';} ?>"></i><span>Nearby hospital</span></p>
            <p><i class="fas fa-<?php if($fetch_property['school'] == 'yes'){echo 'check';}else{echo 'times';} ?>"></i><span>Nearby school(s)</span></p>
            <p><i class="fas fa-<?php if($fetch_property['market_area'] == 'yes'){echo 'check';}else{echo 'times';} ?>"></i><span>Nearby local market area</span></p>
         </div>
      </div>
      <h3 class="title">Detailed description</h3>
