...
if(isset($_POST['submit'])){
   ...
   if($select_users->rowCount() > 0){
      ...
      if($pass != $c_pass){
         $warning_msg[] = 'Password did not match!';
      }else{
...
<section class="form-container">
   ...
   <form action="" method="post">
      ...
      <input type="tel" name="name" required maxlength="50" placeholder="Full Name" class="box">
      <input type="email" name="email" required maxlength="50" placeholder="Email" class="box">
      <input type="number" name="number" required min="0" max="9999999999" maxlength="10" placeholder="Phone number (except 0 at start)" class="box">
      <input type="password" name="pass" required maxlength="20" placeholder="Enter password" class="box">
      <input type="password" name="c_pass" required maxlength="20" placeholder="Re enter password" class="box">
