...
<section class="view-property">
   ...
   <div class="details">
     <div class="swiper images-container">
      ...
      <div class="info">
         <p><i class="fas fa-euro-sign"></i><span><?= $fetch_property['price']; ?></span></p>
      ...
      <div class="flex">
         <div class="box">
            ...
            <p><i>Bedroom(s) :</i><span><?= $fetch_property['bedroom']; ?></span></p>
            <p><i>Bathroom(s) :</i><span><?= $fetch_property['bathroom']; ?></span></p>
            <p><i>Balcony :</i><span><?= $fetch_property['balcony']; ?></span></p>
         </div>
         <div class="box">
            <p><i>Sq ft area :</i><span><?= $fetch_property['carpet']; ?>sq ft</span></p>
            <p><i>Property age :</i><span><?= $fetch_property['age']; ?> Year(s)</span></p>
            <p><i>Total no. of floors :</i><span><?= $fetch_property['total_floors']; ?></span></p>
            <p><i>Floor number :</i><span><?= $fetch_property['room_floor']; ?></span></p>
            <p><i>Furnish Status :</i><span><?= $fetch_property['furnished']; ?></span></p>
            <p><i>Loan availability :</i><span><?= $fetch_property['loan']; ?></span></p>
         </div>
      </div>
      ...
      <div class="flex">
         <div class="box">
            ...
            <p><i class="fas fa-<?php if($fetch_property['water_supply'] == 'yes'){echo 'check';}else{echo 'times';} ?>"></i><span>Free water supply</span></p>
            <p><i class="fas fa-<?php if($fetch_property['power_backup'] == 'yes'){echo 'check';}else{echo 'times';} ?>"></i><span>24/7 power backup</span></p>
         </div>
         <div class="box">
            <p><i class="fas fa-<?php if($fetch_property['parking_area'] == 'yes'){echo 'check';}else{echo 'times';} ?>"></i><span>Parking</span></p>
            <p><i class="fas fa-<?php if($fetch_property['gym'] == 'yes'){echo 'check';}else{echo 'times';} ?>"></i><span>Gym</span></p>
            <p><i class="fas fa-<?php if($fetch_property['shopping_mall'] == 'yes'){echo 'check';}else{echo 'times';} ?>"></i><span>Nearby shopping mall</span></p>
            <p><i class="fas fa-<?php if($fetch_property['hospital'] == 'yes'){echo 'check';}else{echo 'times';} ?>"></i><span>Nearby hospital</span></p>
            <p><i class="fas fa-<?php if($fetch_property['school'] == 'yes'){echo 'check';}else{echo 'times';} ?>"></i><span>Nearby schools</span></p>
            <p><i class="fas fa-<?php if($fetch_property['market_area'] == 'yes'){echo 'check';}else{echo 'times';} ?>"></i><span>Nearby local market area</span></p>
         </div>
      </div>
